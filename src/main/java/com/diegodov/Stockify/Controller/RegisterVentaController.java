...
public class RegisterVentaController {
    ...
    //guardar venta
    @PostMapping("/save")
    public String saveVenta(Venta venta, Model model, @RequestParam("client") Long id) {
        ...
        for (Cart cartItem : cart) {
            ...
            Venta ventaItem = new Venta(product, cartItem.getQuantity(), cartItem.getCost(), cartItem.getTotal(), client);
